    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width:675px;">
        <div class="modal-content">
            <div class="modal-header border-0">
                <h5 class="modal-title small fw-semibold" id="createProfileModalLabel">Add Aircraft</h5>
            ...
            <div class="modal-body">
                <form action="create-profile.php" method="post">
                    ...
                    <div class="mb-3">
                        <label for="profile" class="form-label fw-semibold">Aircraft <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="profile" id="profile" placeholder="Enter aircraft name " required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="Fuel" class="form-label fw-semibold">Fuel <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="Fuel" id="Fuel" placeholder="Enter fuel" required>
                    </div>
                    <div class="mb-3">
                        <label for="TurningTime" class="form-label fw-semibold">Turning Time <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="TurningTime" id="TurningTime" placeholder="Enter turning time" required>
                    </div>
                    <div class="mb-3">
                        <label for="TurningTime" class="form-label fw-semibold">Break time <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="TurningTime" id="TurningTime" placeholder="Enter break time" required>
                    </div>
                    <div class="mb-3">
                        <label for="Pax" class="form-label fw-semibold">Pax <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="Pax" id="Pax" placeholder="Enter pax" required>
                    </div>
        ...
        <div class="modal-content">
            <div class="modal-header border-0">
                <div class="flex-shrink-0">
                    <svg width="48" height="48" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><path fill-rule="evenodd" clip-rule="evenodd" d="M44 24a20 20 0 1 1-40 0 20 20 0 0 1 40 0M24 35.5a1.5 1.5 0 0 0 1.5-1.5V22a1.5 1.5 0 1 0-3 0v12q.1 1.3 1.5 1.5M24 14a2 2 0 1 1 0 4 2 2 0 0 1 0-4" fill="#ffab00"/></svg>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p class="text-dark">
                    This aircraft <b>Jump 3-6</b> is currently assigned to one or more active loads. They will remain visible in those existing loads, but will not be available for any new loads until reactivated. Are you sure you want to inactivate this aircraft ?”
                </p> 
                <div class="d-flex justify-content-end mt-3 gap-2">
                    <button type="button" class="btn btn-outline-secondary small rounded-pill px-4" data-bs-dismiss="modal">No</button>
                    <button type="submit" class="btn btn-primary small fw-bold blue rounded-pill px-4">Yes</button>
                </div>
            </div>
        </div>
    </div>
...
<!-- PROFILE CREATE MODEL --> 
<div class="modal fade" id="lastStepModal" tabindex="-1" aria-labelledby="lastStepModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width:512px;">
        <div class="modal-content">
            <div class="modal-header border-0">
                <div class="flex-shrink-0">
            ...
            <div class="modal-body">
                <p class="text-dark">
                    On re-activate the aircraft <b>Jump 3-6</b>, will become available for assignment in all new loads, Are you sure want to re-activate again?
                </p> 
                <div class="d-flex justify-content-end mt-3 gap-2">
                    <button type="button" class="btn btn-outline-secondary small rounded-pill px-4" data-bs-dismiss="modal">No</button>
                    <button type="submit" class="btn btn-primary small fw-bold blue rounded-pill px-4">Yes</button>
...
?>
 <script>
  const modalOneEl = document.getElementById('createProfileModal');
  const modalTwoEl = document.getElementById('nextStepModal');

  const modalOne = new bootstrap.Modal(modalOneEl);
  const modalTwo = new bootstrap.Modal(modalTwoEl);

  document.getElementById('openModalTwo').addEventListener('click', () => {
    modalOne.hide();
