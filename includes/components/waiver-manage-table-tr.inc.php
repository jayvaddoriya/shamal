...
<td>Tandem</td>
<td>Skydive Dubai Palm</td>
<td>
    <span class="text-success fw-bold ">10/10/2026</span>
</td>
<td>Khalid Ahmed</td>  
<td>
...
<td>
    <div class="d-inline-flex gap-2">
        ...
        <button class="btn ac__btn btn-primary p-0" type="button"
             data-bs-toggle="offcanvas" data-bs-target="#offcanvaswithNoteDetail" aria-controls="offcanvasAuditDetail1"
        > 
            <svg width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><g clip-path="url(#a)" stroke="#fff" stroke-width="1.667" stroke-linecap="round" stroke-linejoin="round"><path d="M.833 10S4.167 3.333 10 3.333 19.167 10 19.167 10 15.833 16.666 10 16.666.833 10 .833 10"/><path d="M10 12.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h20v20H0z"/></clipPath></defs></svg>
        </button> 
        <button class="btn ac__btn"
            type="button" data-bs-toggle="modal" data-bs-target="#auditLogModal"
        >
            <svg width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path fill-rule="evenodd" clip-rule="evenodd" d="M3.23 3.23A2.5 2.5 0 0 1 5 2.5h6.67a2.5 2.5 0 0 1 2.5 2.5v.83H15a2.5 2.5 0 0 1 2.5 2.5V15a2.5 2.5 0 0 1-2.5 2.5H8.33a2.5 2.5 0 0 1-2.5-2.5v-.83H5a2.5 2.5 0 0 1-2.5-2.5V5c0-.66.26-1.3.73-1.77M7.5 15c0 .46.37.83.83.83H15c.46 0 .83-.37.83-.83V8.33A.83.83 0 0 0 15 7.5H8.33a.83.83 0 0 0-.83.83zm5-9.17H8.33a2.5 2.5 0 0 0-2.5 2.5v4.17H5a.83.83 0 0 1-.83-.83V5A.83.83 0 0 1 5 4.17h6.67a.83.83 0 0 1 .83.83z" fill="#212529"/><path fill-rule="evenodd" clip-rule="evenodd" d="M3.23 3.23A2.5 2.5 0 0 1 5 2.5h6.67a2.5 2.5 0 0 1 2.5 2.5v.83H15a2.5 2.5 0 0 1 2.5 2.5V15a2.5 2.5 0 0 1-2.5 2.5H8.33a2.5 2.5 0 0 1-2.5-2.5v-.83H5a2.5 2.5 0 0 1-2.5-2.5V5c0-.66.26-1.3.73-1.77M7.5 15c0 .46.37.83.83.83H15c.46 0 .83-.37.83-.83V8.33A.83.83 0 0 0 15 7.5H8.33a.83.83 0 0 0-.83.83zm5-9.17H8.33a2.5 2.5 0 0 0-2.5 2.5v4.17H5a.83.83 0 0 1-.83-.83V5A.83.83 0 0 1 5 4.17h6.67a.83.83 0 0 1 .83.83z" fill="#000" fill-opacity=".2"/></svg>
        </button>
        <button class="btn ac__btn"
